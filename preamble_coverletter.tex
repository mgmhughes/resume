...
\fancyfoot[L]{{\footnotesize\color{mgmhwine}{This cover letter created with R and LaTeX. \\ See the source code at }\color{RoyalPurple}{https://github.com/mgmhughes/resume}\normalfont}}
